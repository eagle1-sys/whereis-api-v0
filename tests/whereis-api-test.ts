...
async function assertResponse(
  ...
  switch (true) {
    ...
    default: {
      throw new Error(
          `Unexpected expectedOutput format: ${JSON.stringify(expectedOutput)}. Expected output should contain either 'error' or 'eventNum' key. Received response: ${JSON.stringify(responseJSON)}`,);
    }
  }
}
